...
urlpatterns = [
  ...
  path('delete_business/<int:business_id>',app_views.delete_business,name='delete_business'),
  path('update_business/<int:business_id>',app_views.update_business,name='update_business'),
  path('delete_post/<int:post_id>',app_views.delete_post,name='delete_post'),
  path('update_post/<int:post_id>',app_views.update_post,name='update_post'),
  path('update_neighborhood/<int:neighborhood_id>',app_views.update_neighborhood,name='update_neighborhood'),
  path('delete_neighborhood/<int:neighborhood_id>',app_views.delete_neighborhood,name='delete_neighborhood'),
  path('users/<int:pk>',app_views.users_profile,name='users_profile'),
]